...
public class IndexStorageSelfTest extends GridCommonAbstractTest {
    ...
    public void testIndexRebuildMarkers() throws Exception {
        ...
        try {
            IndexStorage idxStore = createMetaStorage("group".hashCode(), mem);
    ...
    private void metaAllocation() throws Exception {
        ...
        try {
            ...
            for (int i = 0; i < 1_000; i++) {
                ...
                if (metaStore == null) {
                    metaStore = createMetaStorage(cacheId, mem);
     ...
     * @throws Exception If failed.
     */
    private IndexStorage createMetaStorage(int cacheId, PageMemory mem) throws Exception {

...
public abstract class BPlusTree<L, T extends L> extends DataStructure implements IgniteTree<L, T> {
    ...
    private String printPage(BPlusIO<L> io, long pageAddr, boolean keys) throws IgniteCheckedException {
        ...
        b.append("rmvId=").append(io.getRemoveId(pageAddr)).append(' ');
    ...
    private class SweepCursor implements GridCursor<Void> {
        ...
        private void doPurge(long pageId) throws IgniteCheckedException {
            ...
            try {
                ...
                try {
                    ...
                    dirty = modifyPage(io, pageAddr, cnt);
                }
                finally {
         ...
         */
        private boolean modifyPage(BPlusIO<L> io, long pageAddr, int cnt) throws IgniteCheckedException {
            int write = -1;
            int read = -1;
            int idx = 0;
            boolean dirty = false;
            ...
            if (dirty) {
                ...
                io.setCount(pageAddr, cnt);//TODO: need new walrecord
            }

            if (h) // rightmost row is eligible for removal
